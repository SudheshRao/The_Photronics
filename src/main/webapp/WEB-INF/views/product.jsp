	...
	<div class="form-horizontal">
		<div class="form form-group-lg">
			...
			<form:errors path="*" cssClass="error"/>
				...
				<form:input path="instrument" id="Instrument" class="form-control" placeholder="Instrument"/>
				...
				<form:input path="spec" id="Specification" class="form-control" placeholder="specification"/>
			<form:errors path="spec" cssClass="error"/>
				...
				<form:input path="stock" id="stock" class="form-control" placeholder="In Stock" />
