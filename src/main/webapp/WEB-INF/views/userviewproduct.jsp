...
<meta name="viewport" content="width=device-width, initial-scale=1"/>
		...
		<link href="<c:url value="/resources/theme/css/product.css" />" rel="stylesheet"/>
</head>
<body>
<div style="min-height:60px;"></div> 
	...
	<c:forEach items="${viewpro}" var="p">
		...
		<div class="container col-sm-6 col-md-6 col-lg-6" style="height:auto;background:white;border:10px solid #212121;">
			<div class="row"><div>
			<div onclick="location.href='infoproduct/${p.id}';"style="cursor: pointer;text-decoration:none; color:black;">
				...
				<div class="cd col-sm-6" >
					...
					<p style="text-align:left;color:red;"><span class="fa fa-inr"></span> <b> ${p.cost}</b></p>
